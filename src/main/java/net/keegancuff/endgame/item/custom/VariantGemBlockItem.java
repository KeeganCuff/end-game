...
public class VariantGemBlockItem extends BlockItem {
    public VariantGemBlockItem(Block block, Settings settings) {
    ...
    public BlockState getPlacementState(ItemPlacementContext context) {
        ...
        state = state.with(VariantGemBlock.COLOR, nbt.getInt(ModColorProvider.MOD_COLOR_NBT_ID));
        return state;
    }
