...
public class VariantGemScreen extends Screen {
    ...
    public VariantGemScreen(ItemStack stack) {
        super(Text.literal("Variant Gem"));
        gem = stack;
    }
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        drawCenteredText(matrices, textRenderer, "Variant Gem", width/2, 30, 0xffffff);
    ...
    private void addElements() {
        ...
        colorField.setText("" + gem.getOrCreateNbt().getInt(ModColorProvider.MOD_COLOR_NBT_ID));
